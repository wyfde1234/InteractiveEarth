...
AngleCaculator::AngleCaculator(const osgEarth::SpatialReference* srs, osg::Group* annoGroup) :_srs(srs), _annoGroup(annoGroup), _isEnable(false)
{
	_pFeature = NULL;
	_pFeatureNode = NULL;
...
osg::Vec3d AngleCaculator::getPos(const osgGA::GUIEventAdapter& ea,
